...
public class AdminServiceImpl implements AdminService {
	...
	/* (non-Javadoc)
	 * @see com.bookstore.service.AdminService#modifyUserPwd(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.bookstore.service.AdminService#addBook(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, double, int, int)
	 */
	@Override
	public ResponseMes addBook(String isbn, String title, String author, String publisher, String summary,
		...
		if (ISBNUtil.isISBN(isbn)) {
			if (book == null) {// 若图书不存在,则插入图书信息
				...
				adminMapper.updateBookNum(isbn, degree, num);
			}
